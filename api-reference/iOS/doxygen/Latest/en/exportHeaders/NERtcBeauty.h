 ...
 * @note The method must be called before {@link INERtcEngine#enableLocalVideo}.
 * @since V4.2.202
 * @return
 * - 0: success.
 ...
 * @note 该方法需要在 {@link INERtcEngine#enableLocalVideo} 之前设置。
 * @since V4.2.202
 * @return
 * - 0：方法调用成功；
 ...
 * @note 
 * - 使用滤镜、贴纸和美妆等自定义美颜效果之前，需要先通过 {@link NERtcBeauty#addTempleteWithPath:andName:} 方法导入美颜资源或模型。
 ...
 * @note 
 * - 使用滤镜、贴纸和美妆等自定义美颜效果之前，需要先通过方法 {@link NERtcBeauty#addTempleteWithPath:andName:} 导入美颜资源或模型。
