...
typedef NS_ENUM(NSInteger, NERtcAudioProfileType) {
    ...
    /**
     * @if English
     * Medium sound quality mode. Sample rate: 48 kHz, music encoding, mono, and maximum bitrate: 32 kbps.
     * @endif
     * @if Chinese
    ...
    /**
     * @if English
     * Medium sound quality mode (stereo). Sample rate: 48 kHz, music encoding, stereo, and maximum bitrate: 64 kbps.
     * @endif
     * @if Chinese
    ...
    /**
     * @if English
     * High sound quality mode. Sample rate: 48 kHz, music encoding, mono, and maximum bitrate: 64 kbps.
     * @endif
     * @if Chinese
