 ...
 * - 直播推流错误码：{@link NERtcEngineErrorCode.kNERtcLiveStreamError}
...
<table>
 ...
 <table>
  ...
  <tr>
    <td> {@link INERtcEngineEx#setLocalCanvasWatermarkConfigs:withStreamType:}</td>
  ...
  <tr>
    <td> {@link INERtcEngineEx#setRemoteCanvasWatermarkConfigs:forUserID:withStreamType:}</td>
